...
urlpatterns = [
    ...
    path('transaction/students/<int:pk>', transaction.transaction_details_student),
    ...
    path('report/student-with-three-book-issued/', report.student_with_three_book_issued),
